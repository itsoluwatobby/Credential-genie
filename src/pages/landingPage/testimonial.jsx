...
const Testimonials = () => {
  const renderCard = (item) => {
    return (
      <article
        key={item.id}
        className="rounded-xl p-8 border border-gray-100 bg-gray-100 flex flex-col gap-7"
      >
        ...
        <h4 className="text-3xl text-primary-100">{item.name}</h4>
      </article>
    );
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-[max-content_1fr] gap-10 md:gap-5">
          <article className="flex flex-col gap-2">
            ...
            <h4 className="max-w-[15ch] text-4xl">
              Don’t believe us? Check what our users think of us.
            </h4>
          </article>
